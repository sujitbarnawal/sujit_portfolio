  ...
  export const projects = [
    {
      ...
      description:
        "MithoMitho, a food delivery application designed to connect users withdelicious foods. Developed as part of the CSC 370 course at Tribhuwan University, MithoMitho aims to provide a user-friendly, efficient, and secure platform for customers to browse menus, place orders, and track deliveries seamlessly.",
      image: fooddelLogo,
      tags: ["HTML", "TailwindCSS", "JavaScript", "React JS", "Express JS","Node JS"],
